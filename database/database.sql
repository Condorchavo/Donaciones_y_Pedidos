...
-- -----------------------------------------------------
-- Table `database`.`comuna`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `database`.`comuna` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(200) NOT NULL,
...
-- -----------------------------------------------------
-- Table `database`.`donacion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `database`.`donacion` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `database`.`foto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `database`.`foto` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_foto_donacion1`
    ...
    REFERENCES `database`.`donacion` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `database`.`pedido`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `database`.`pedido` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `comuna_id` INT NOT NULL,
  `tipo` ENUM('fruta', 'verdura', 'otro') NOT NULL,
  `descripcion` VARCHAR(80) NULL,
